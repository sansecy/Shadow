...
import org.gradle.internal.impldep.com.sun.istack.Nullable
...
class Level1DependencyModelBuilder2 implements DependencyModelBuilder<DependenciesImpl> {
    ...
    @Override
    void addArtifact(@NotNull ResolvedArtifact artifact,
                     boolean isProvided,
                     @Nullable Map<ComponentIdentifier, ? extends File> lintJarMap,
                     @NotNull ClasspathType type) {
