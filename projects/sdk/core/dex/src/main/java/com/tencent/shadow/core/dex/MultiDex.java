...
package com.tencent.shadow.core.dex;
...
public final class MultiDex {
    ...
    public static void install(Context context,String sourceDir,String prefix) {
        Log.i("MultiDex", "Installing application");
        if (IS_VM_MULTIDEX_CAPABLE) {
            Log.i("MultiDex", "VM has multidex support, MultiDex support library is disabled.");
        } else if (VERSION.SDK_INT < 4) {
            ...
            try {
                ...
                doInstallation(context, new File(sourceDir), new File(applicationInfo.dataDir), prefix + "secondary-dexes", prefix + "");
            } catch (Exception var2) {
                Log.e("MultiDex", "MultiDex installation failure", var2);
                throw new RuntimeException("MultiDex installation failed (" + var2.getMessage() + ").");
            }
    ...
    public static void doInstallation(Context mainContext, File sourceApk, File dataDir, String secondaryFolderName, String prefsKeyPrefix) throws IOException, IllegalArgumentException, IllegalAccessException, NoSuchFieldException, InvocationTargetException, NoSuchMethodException {
        doInstallation(mainContext, mainContext.getClassLoader(), sourceApk, dataDir, secondaryFolderName, prefsKeyPrefix);
    }

    public static void doInstallation(Context mainContext, ClassLoader loader, File sourceApk, File dataDir,
