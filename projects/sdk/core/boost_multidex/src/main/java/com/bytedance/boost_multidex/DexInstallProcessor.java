...
class DexInstallProcessor {
    ...
    void doInstallation(final Context mainContext, File sourceApk, ClassLoader classLoader, String dirKey, Result result) throws Exception {
        ...
        File rootDir = Utility.ensureDirCreated(filesDir, Constants.BOOST_MULTIDEX_DIR_NAME + "_" + dirKey);
        ...
        try {
            ...
            installSecondaryDexes(classLoader, dexHolderList);
    ...
    void doInstallationInOptProcess(ClassLoader classLoader, File apkFile) throws Exception {
        ...
        DexLoader.create(Build.VERSION.SDK_INT).install(classLoader, dexHolderList);
        apkZipFile.close();
