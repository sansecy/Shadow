...
class ActivityCodeGenerator {
    ...
    companion object {
        const val ACTIVITY_CONTAINER_PACKAGE = "cn.migu.gamehall.shadow.core.runtime.container"
        const val RUNTIME_PACKAGE = "cn.migu.gamehall.shadow.core.runtime"
        const val DELEGATE_PACKAGE = "cn.migu.gamehall.shadow.core.loader.delegates"
...
//            addMethod("getResources")
         ...
         *
         * 但是在cn.migu.gamehall.shadow.core.loader.ShadowPluginLoader.getHostActivityDelegate中，
    ...
    val commonJavadoc =
        "由\n" + "{@link cn.migu.gamehall.shadow.coding.code_generator.ActivityCodeGenerator}\n" + "自动生成\n"
