...
public class ActivityThreadCompat {
    ...
    static {
        if (Build.VERSION.SDK_INT >= 33) {
            currentActivityThread = ActivityThread33.currentActivityThread;
            Log.d(TAG, "static initializer() called = " + currentActivityThread);
            getProcessName = ActivityThread33.getProcessName;
            getHandler = ActivityThread33.getHandler;
            installProvider = ActivityThread33.installProvider;
            mBoundApplication = ActivityThread33.mBoundApplication;
            mH = ActivityThread33.mH;
            mInitialApplication = ActivityThread33.mInitialApplication;
            mInstrumentation = ActivityThread33.mInstrumentation;
            mPackages = ActivityThread33.mPackages;
            mProviderMap = ActivityThread33.mProviderMap;
            performNewIntents = ActivityThread33.performNewIntents;
            sPackageManager = ActivityThread33.sPackageManager;
            sendActivityResult = ActivityThread33.sendActivityResult;
            getApplicationThread = ActivityThread33.getApplicationThread;
        } else {
            currentActivityThread = ActivityThread.currentActivityThread;
            Log.d(TAG, "static initializer() called = " + currentActivityThread);
            getProcessName = ActivityThread.getProcessName;
            getHandler = ActivityThread.getHandler;
            installProvider = ActivityThread.installProvider;
            mBoundApplication = ActivityThread.mBoundApplication;
            mH = ActivityThread.mH;
            mInitialApplication = ActivityThread.mInitialApplication;
            mInstrumentation = ActivityThread.mInstrumentation;
            mPackages = ActivityThread.mPackages;
            mProviderMap = ActivityThread.mProviderMap;
            performNewIntents = ActivityThread.performNewIntents;
            sPackageManager = ActivityThread.sPackageManager;
            sendActivityResult = ActivityThread.sendActivityResult;
            getApplicationThread = ActivityThread.getApplicationThread;
        }
    }
    ...
    public static class ActivityClientRecord {
        public static Class<?> TYPE = RefClass.load(ActivityThread.ActivityClientRecord.class, "android.app.ActivityThread$ActivityClientRecord");
    ...
    public static class ProviderClientRecord {
        public static Class<?> TYPE = RefClass.load(ActivityThread.ProviderClientRecord.class, "android.app.ActivityThread$ProviderClientRecord");
    ...
    public static class ProviderClientRecordJB {
        public static Class<?> TYPE = RefClass.load(ActivityThread.ProviderClientRecordJB.class, "android.app.ActivityThread$ProviderClientRecord");
        public static RefObject<Object> mHolder;
        public static RefObject<IInterface> mProvider;
    }

    public static class ProviderKeyJBMR1 {
        public static Class<?> TYPE = RefClass.load(ActivityThread.ProviderKeyJBMR1.class, "android.app.ActivityThread$ProviderKey");
        @MethodParams({String.class, int.class})
        public static RefConstructor<?> ctor;
    }

    public static class AppBindData {
        public static Class<?> TYPE = RefClass.load(ActivityThread.AppBindData.class, "android.app.ActivityThread$AppBindData");
    ...
    public static class H {
        public static Class<?> TYPE = RefClass.load(ActivityThread.H.class, "android.app.ActivityThread$H");
